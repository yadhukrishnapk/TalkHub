      ...
      {selectedUsername ? (
        ...
        <div className="flex flex-col h-full">
          <div className="bg-[#121212] flex items-center px-4 py-3 border-b border-gray-800">
            ...
            <div className="flex-1 font-medium text-white">{selectedUsername}</div>
            <Sheet>
              ...
              <SheetContent side="right" className="p-0 w-full sm:w-80 bg-[#121212] border-l border-gray-800">
