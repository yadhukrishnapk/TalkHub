...
import { Send, Webhook, Smile, ArrowUpCircle } from "lucide-react";
  ...
  return (
    <div className="p-4 border-t border-gray-700 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="flex items-center relative z-10 gap-3">
        {/* Emoji Picker with improved icon */}
        ...
        {/* Enhanced Input with autogrow functionality */}
      ...
      {/* Character count indicator that appears when typing */}
      {newMessage.length > 0 && (
